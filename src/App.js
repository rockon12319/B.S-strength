...
image: "/fighter1.jpg",
content: <p>常常有人問：「打格鬥技巧好就好，還需要另外花時間練肌力嗎？」🤔</p> <br/> <p>其實不只是格鬥，任何專項選手練了<strong>肌力訓練</strong>，場上表現絕對會突飛猛進！今天就來跟大家聊聊這背後的秘密。👇</p> <br/> <h3 class="text-xl font-bold text-orange-500 mb-2">🛡️ 變強壯、受傷少，專項表現大升級！</h3> <p>很多人以為練好專項技術就夠了，但加入專業的<strong>肌力與體能</strong>訓練，不僅可以讓你更有效率地徵召肌肉與發揮力量，最重要的是能「保護你的身體」！在激烈對抗或高強度競技中，強健的身體素質就是預防運動傷害最強的護盾。💪</p> <br/> <h3 class="text-xl font-bold text-orange-500 mb-2">🥊 麒舜教練的十幾年血淚經驗談</h3> <p>回想我這十幾年的格鬥生涯，真的是點滴在心頭啊！😂 以前還沒有接觸系統化訓練前，總覺得明明很用力了，但打出去的拳頭就是沒什麼破壞力。</p> <br/> <p>直到開始認真投入<strong>桃園肌力訓練</strong>之後，才發現世界完全不一樣了！不僅出拳的爆發力與穿透力差了非常多，甚至在近身纏鬥、摔技對抗的時候，身體的穩定度跟力量抗衡也有著天壤之別！這也是為什麼我們在<strong>桃園健身房</strong>一直大力推廣重量訓練的原因。🔥</p> <br/> <h3 class="text-xl font-bold text-orange-500 mb-2">🌱 任何人都能透過訓練變得更好</h3> <p>不只是競技選手需要，一般大眾也一樣喔！在 <strong>bs-strength</strong> 的課程中，無論你是想提升運動表現、想要<strong>抗老化訓練</strong>的熟齡族群，或是需要<strong>銀髮族訓練</strong>的長輩，我們 B.S 力線體的教練團隊都能幫你打下最穩固的身體基礎！🏋️‍♂️</p> <br/> <p class="text-lg font-bold text-white border-l-4 border-orange-500 pl-4 py-2 bg-neutral-800 rounded-r-lg">想體會力量充盈全身的感覺嗎？別再讓身體潛能沉睡了，歡迎來<strong>桃園健身</strong>找我們，一起把身體的潛力發揮到極致吧！💥</p>,
}
  {
    id: 10,
  ...
  },
  {
    ...
    content: `
      ...
      <ul class="space-y-4 my-4 text-gray-300">
        <li><strong>✅ 想增強身體素質？</strong><br/>你應該透過系統化的「力量訓練」來達成。這也是我們 B.S 力線體 最擅長的事，幫你打好身體的根基，讓你擁有抗老化、防受傷的強韌肉體。</li>
      ...
      <p>不管你是職業運動員，還是熱愛運動的素人，甚至是追求健康生活的銀髮族，肌力訓練都是你最穩賺不賠的投資。</p>
      <br/>
  ...
  return (
    <div className="font-sans text-gray-100 bg-neutral-900 min-h-screen selection:bg-orange-500 selection:text-white">
      ...
      <main>
        ...
        {currentView === "blog" && <BlogList navigateTo={navigateTo} />}
        {currentView === "post" && (
          <BlogPost postId={selectedPostId} navigateTo={navigateTo} />
        )}
      </main>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <ReviewCard
              name="王小姐"
              tag="泰拳團體課"
              content="以前覺得格鬥很可怕，但教練教得非常有趣，上課氣氛很好同學們都很友善。每次打完拳都爆汗，壓力完全釋放，超級推薦！"
            />
            <ReviewCard
              name="張媽媽"
              tag="銀髮族肌力訓練"
...
const CoachCard = ({
  ...
  >
    <div className="h-[30rem] overflow-hidden relative bg-neutral-700 shrink-0">
      <img
        src={image}
        alt={altText}
    ...
    <div className="p-6 flex-grow flex flex-col gap-6 relative">
      ...
      {achievements && achievements.length > 0 && (
        <div>
          ...
          <ul className="text-sm text-gray-400 space-y-1 list-disc list-inside max-h-56 overflow-y-auto pr-2 custom-scrollbar">
